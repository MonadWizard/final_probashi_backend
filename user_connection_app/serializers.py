...
class UserFavouriteListSerializer(serializers.ModelSerializer):
    ...
    favourite_user_photo = serializers.ImageField(
        source="favourite_userid.user_photopath"
    )
    favourite_user_designation = serializers.CharField(
        source="favourite_userid.user_currentdesignation"
    )
    is_favourite_user_consultant = serializers.BooleanField(
        source="favourite_userid.is_consultant"
    )
