...
urlpatterns = [
    ...
    # path('user-about-social-link-update/', UserAboutSocialLinkUpdate.as_view(), name="UserAboutSocialLinkUpdate"),
    ...
    # path('user-social-create-update/<str:userid>/', UpdateOrCreateSocialAbout.as_view(), name="UpdateOrCreateSocialAbout"),
